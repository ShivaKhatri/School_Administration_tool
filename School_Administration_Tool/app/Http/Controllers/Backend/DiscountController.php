...
class DiscountController extends Controller
{
     ...
     */
    public function index(DiscountDataTable $section)
    {

        return  $section->render('backend.discount.indexDiscount');
    ...
    public function create()
    {
        ...
        return view('backend.discount.createDiscount')->with('class',$class);
...
//['class_id', 'student_id', 'paid_status', 'staff_id', 'amount','description','session_year','name'];
    ...
    {
        $fee=Discount::find($id);
        $class=ClassRoom::all()->pluck('name','id');
        return view('backend.discount.editDiscount')->with('class',$class)->with('discount',$fee);
    }
