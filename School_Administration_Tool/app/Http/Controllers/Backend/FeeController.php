...
class FeeController extends Controller
{
     ...
     */
    public function index(FeeDataTable $section)
    {

        return  $section->render('backend.fee.feeIndex');
    ...
    public function create()
    {
        ...
        return view('backend.fee.feeCreate')->with('class',$class);
...
//['class_id', 'student_id', 'paid_status', 'staff_id', 'amount','description','session_year','name'];
    ...
    public function edit($id)
    {
        $fee=Fee::find($id);
        $class=ClassRoom::all()->pluck('name','id');
        return view('backend.fee.feeEdit')->with('class',$class)->with('fee',$fee);
    }
