        ...
        return datatables($query)
            ->addColumn('action', function ($student) {
                if($student->paid_status==0)
                    return '<a href="'.route('discount.edit',$student->id).'" class="btn btn-sm btn-primary" style="margin:3px"><i
                                                    class="glyphicon glyphicon-edit"></i> Edit</a></a>&nbsp;&nbsp;<a href="'.route('discount.destroy',$student->id).'" class="btn btn-sm btn-danger" id="delete" ><i class="glyphicon glyphicon-remove"></i> Delete</a>';
                else
            ...
            ->addColumn('class', function ($student) {
                $class=Discount::find($student->id)->classRoom()->first();
                if($class==null){
            ...
            ->addColumn('student', function ($student) {
                $class=Discount::find($student->id)->student()->first();
                if($class==null){
