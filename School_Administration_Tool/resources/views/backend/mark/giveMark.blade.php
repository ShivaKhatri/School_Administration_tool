...
@section('content')
    <div class="row">
        ...
        <div class="box box-primary">
            ...
            {!! Form::open(array('route'=>'mark.store', 'class' =>"form-horizontal form-label-left", 'method' => 'post', 'id'=>'sectionForm', 'enctype' => "multipart/form-data")) !!}
            <div class="box-body">
                @if($errors->any())
                ...
                <div class="col-md-4 col-sm-4 col-xs-12 form-group">
                    ...
                    <div class="input-group col-md-11 col-sm-11 col-xs-12">
                        ...
                        {!! Form::select('exam_id', $exam, null, ["class" => "form-control" ,'required' => '','placeholder'=>"Select Exam "]) !!}
