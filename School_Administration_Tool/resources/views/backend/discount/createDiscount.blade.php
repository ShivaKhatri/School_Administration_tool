...
@section('content')
    {!! Form::open(array('route'=>'discount.store', 'class' =>"form-horizontal form-label-left", 'method' => 'post', 'id'=>'sectionForm', 'enctype' => "multipart/form-data")) !!}
    ...
    <div class="box box-primary">
        ...
        <div class="box-body">
            ...
            <div class="form-group">
                ...
                <div class="col-md-6 col-sm-6 col-xs-12">
                    {{ Form::select('type',[''=>'Discount For','class'=>'For a Class','student'=>'For a particular student'],null, array('class' => 'form-control col-md-7 col-xs-12','required'=>'')) }}
                </div>
            </div>
            <div class="form-group">
