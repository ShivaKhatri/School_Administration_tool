...
@section('content')
    <div class="row">
        ...
        <div class="box box-primary">
            ...
            {!! Form::model($subject, [
                  'route' => ['subject.update', $subject->id],
            ...
            <div class="box-body">
                ...
                <textarea class="textarea" placeholder="Place some text here" name="description"
                          style="width: 100%; height: 200px; font-size: 14px; line-height: 18px; border: 1px solid #dddddd; padding: 10px;">{{$subject->description}}</textarea>
                        </form>
                    </div>
                </div>
            </div>
