{{--used the frontend of adminlites template login page --}}
        <!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
...
<div class="login-box">
    ...
    <div class="login-box-body form-group{{ $errors->has('email') ? ' has-error' : '' }}">
        ...
        <a href="{{route('registerGuardian')}}"> registe</a>

        <form  role="form" method="POST" action="{{ url('/guardian/loginGuardian') }}">
            {{ csrf_field() }}
