...
{{--                                    {{Auth::guard('staff')->user()->name}} - "Role"--}}
                            ...
                            <li class="user-footer">
                                ...
                                <div class="pull-right">
                                    <form  role="form" method="POST" action="{{route('logoutStaff')}}">
                                        {{ csrf_field() }}
...
{{--                    <p>{{Auth::guard('staff')->user()->name}}</p>--}}
            ...
            <ul class="sidebar-menu" data-widget="tree">
                ...
                @if(Auth::guard('staff')->user()->role=="Admin")
                    ...
                    <li><a href="{{route('mark.index')}}">Marked Exams</a></li>
                @elseif(Auth::guard('staff')->user()->role=="ClassTeacher")
                    <li><a href="{{route('attendance.index')}}">Attendance</a></li>
                    <li><a href="{{route('attendance.create')}}">Take Attendance</a></li>
                    <li><a href="{{route('mark.index')}}">Marked Exams</a></li>
                    <li><a href="{{route('mark.create')}}">Mark Subjects</a></li>


                @elseif(Auth::guard('staff')->user()->role=="Teacher")
                    @else
                    {{redirect('/')}}
                @endif
